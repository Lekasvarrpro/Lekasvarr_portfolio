...
import { ArrowDown, Github, Linkedin, Mail, FileDown, Code, Trophy } from "lucide-react";
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex justify-center gap-6">
          ...
          <motion.a
            whileHover={{ scale: 1.3, rotate: 10 }}
            href="https://leetcode.com/u/lekasvarr"
            target="_blank"
          >
            <Code size={26}/>
          </motion.a>
          ...
          <motion.a
            whileHover={{ scale: 1.3, rotate: 10 }}
            href="https://www.hackerrank.com/Lekasvarr424"
            target="_blank"
          >
            <Trophy size={26}/>
          </motion.a>
